...
public class SwerveModule {
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_turningSparkMax.set(m_turningPIDController.calculate(m_turningEncoder.getPosition(), optimizedDesiredState.angle.getDegrees()));
  ...
  public void setDesiredStateNoOpt(SwerveModuleState desiredState) {
    ...
    m_turningSparkMax.set(m_turningPIDController.calculate(m_turningEncoder.getPosition(), correctedDesiredState.angle.getDegrees()));
